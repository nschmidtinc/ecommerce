        ...
        return (<div className="App">
            ...
            <div>
                <div className="AccountInfo">
                    ...
                    <ul><button className="AccountTab" onClick={() => this.switchList('/userListings', "Items Listed by ")}>Display Items Listed</button></ul>
                    <ul><button className="AccountTab" onClick={() => this.switchList('/userBought', "Items purchased by ")}>Display Items Bought</button></ul>
                    <ul><button className="AccountTab" onClick={() => this.switchList('/userSold', "Items sold by ")}>Display Items Sold</button></ul>
                </div>
